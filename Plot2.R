...
# Second question:Have total emissions from PM2.5 decreased in the Baltimore City, Maryland (fips == "24510") from 1999 to 2008? 
# We can use the base plotting system in order to make a plot answering this question.
